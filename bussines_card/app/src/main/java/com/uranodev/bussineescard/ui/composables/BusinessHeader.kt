...
fun BusinessHeader(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        //todo(Cristian): mapear textos
        Image(imagePainter, stringResource(R.string.dev_icon), modifier = Modifier.size(200.dp))
        Text(stringResource(R.string.dev_name), style = )
    }
}